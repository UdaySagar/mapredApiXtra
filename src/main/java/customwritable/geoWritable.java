 ...
 */
public class geoWritable implements WritableComparable<geoWritable> {
    ...
    public boolean equals(Object o) {
        if(o instanceof geoWritable) {
            geoWritable tp = (geoWritable) o;
            return tp.state.equals(state) && tp.city.equals(city);
        }
        return false;
    }

    public int compareTo(geoWritable ct) {
